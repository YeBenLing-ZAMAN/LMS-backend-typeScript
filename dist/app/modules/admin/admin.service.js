...
const updateAdmin = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!isExist) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, "Admin not found! Please");
    }
    // 01- handle embedded
...
const deleteAdmin = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        deletedAdmin = yield admin_model_1.Admin.findOneAndDelete({ id }, { session }).populate("managementDepartment");
        if (!deletedAdmin) {
