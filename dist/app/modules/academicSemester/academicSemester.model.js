...
/* per and post hook in mongooses */
// data-> check -? same year && same semester is exists.
academicSemesterSchema.pre("save", function (next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (isExist) {
            throw new ApiError_1.default(http_status_1.default.CONFLICT, "Same semester is already exists !");
        }
        next();
    });
});
