...
const updateFaculty = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!isExist) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, "Student not found! Please");
    }
    // 01- handle embedded
...
const deleteFaculty = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const isExist = yield faculty_model_1.Faculty.findOne({ id });
        if (!isExist) {
            throw new ApiError_1.default(http_status_1.default.NOT_FOUND, "Faculty not found! Please");
        }
        // const newStudent = await Student.create([student], { session });
        const deleteUser = yield user_model_1.User.findOneAndDelete({ id }, { session });
        if (!deleteUser) {
            throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "Failed to delete user");
        }
        deletedFaculty = yield faculty_model_1.Faculty.findOneAndDelete({ id }, { session })
            .populate("academicDepartment")
            .populate("academicFaculty");
        if (!deletedFaculty) {
