...
exports.generatedAdminId = exports.findLastAdminId = exports.generatedFacultyId = exports.findLastFacultyId = exports.generatedStudentId = exports.findLastUserId = void 0;
...
const findLastUserId = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return (lastStudent === null || lastStudent === void 0 ? void 0 : lastStudent.id) ? (_a = lastStudent === null || lastStudent === void 0 ? void 0 : lastStudent.id) === null || _a === void 0 ? void 0 : _a.substring(4) : undefined;
});
...
const generatedStudentId = (academicSemester) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // 2023
    incrementedId = `${academicSemester === null || academicSemester === void 0 ? void 0 : academicSemester.year.substring(2, 4)}${academicSemester === null || academicSemester === void 0 ? void 0 : academicSemester.code}${incrementedId}`;
...
const findLastFacultyId = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const lastFaculty = yield user_model_1.User.findOne({ role: "faculty" }, { id: 1, _id: 0 })
        ...
        .lean(); // operation make faster
    return (lastFaculty === null || lastFaculty === void 0 ? void 0 : lastFaculty.id) ? (_b = lastFaculty === null || lastFaculty === void 0 ? void 0 : lastFaculty.id) === null || _b === void 0 ? void 0 : _b.substring(2) : undefined;
});
...
const findLastAdminId = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const lastFaculty = yield user_model_1.User.findOne({ role: "admin" }, { id: 1, _id: 0 })
        ...
        .lean(); // operation make faster
    return (lastFaculty === null || lastFaculty === void 0 ? void 0 : lastFaculty.id) ? (_c = lastFaculty === null || lastFaculty === void 0 ? void 0 : lastFaculty.id) === null || _c === void 0 ? void 0 : _c.substring(2) : undefined;
});
