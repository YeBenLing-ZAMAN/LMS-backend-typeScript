...
const login = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const accessToken = jwtHelper_1.jwtHelpers.createToken(
      ...
      config_1.default.jwt.expiries_in
    );
    ...
    const refreshToken = jwtHelper_1.jwtHelpers.createToken(
      ...
      config_1.default.jwt.refresh_expiries_in
    );
    return {
      accessToken,
      refreshToken,
...
const refreshToken = (token) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      verifiedToken = jwtHelper_1.jwtHelpers.verifyToken(
        token,
        config_1.default.jwt.refresh_secret
      );
      //
...
const changePassword = (userinfo, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { oldPassword, newPassword } = payload;
    // checking user?
    const user = new user_model_1.User();
    const isUserExist = yield user_model_1.User.findOne({
      id: userinfo === null || userinfo === void 0 ? void 0 : userinfo.userId,
    }).select("+password");
    if (!isUserExist) {
      throw new ApiError_1.default(
        http_status_1.default.NOT_FOUND,
